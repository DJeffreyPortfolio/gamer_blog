defmodule GamerBlogWeb.PostLiveTest do
  use GamerBlogWeb.ConnCase

  import Phoenix.LiveViewTest
  import GamerBlog.CMSFixtures

  @create_attrs %{community_id: 42, content: "some content", slug: "some slug", title: "some title", total_comments: 42, total_likes: 42}
  @update_attrs %{community_id: 43, content: "some updated content", slug: "some updated slug", title: "some updated title", total_comments: 43, total_likes: 43}
  @invalid_attrs %{community_id: nil, content: nil, slug: nil, title: nil, total_comments: nil, total_likes: nil}
