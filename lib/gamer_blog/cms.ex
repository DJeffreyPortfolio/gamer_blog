defmodule GamerBlog.CMS do
  ...
  def dashboard_feed(user, page, per_page) do
    user = user
    page = page
    per_page = per_page
    f_list = following_list(user)
  ...
  def subscribe do
    Phoenix.PubSub.subscribe(GamerBlog.PubSub, "posts")
  end

  defp broadcast({:error, _reason} = error, _event), do: error

  defp broadcast({:ok, post}, event) do
    Phoenix.PubSub.broadcast(GamerBlog.PubSub, "posts", {event, post})
    {:ok, post}
  end
end
